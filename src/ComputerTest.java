public class ComputerTest {
    public static void main(String[] args) {
        Procesor proc1 = new Procesor("Intel","72", "1GHz");
        Procesor proc2 = new Procesor("Lenovo","GG", "5 GHz");
        Memory mem1 = new Memory("Nvidia","Bravo", "2 GHz");
        Memory mem2 = new Memory("Gforce", "XX", "10 GHz");
